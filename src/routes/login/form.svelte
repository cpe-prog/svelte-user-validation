...
<div class="flex h-screen w-full items-center justify-center">
	<form class=" w-80" method="POST" use:enhance>
		...
		<h2 class="mb-5 text-center">Login to SvelteUI</h2>
		<div class="rounded-lg border border-secondary p-6">
			...
			<Form.Button class="mt-5 w-full" size="sm" variant="secondary">Login</Form.Button>
		</div>
		<h4 class="mt-4 text-center">
			Don't have account? <a class="hover:text-slate-500 hover:underline" href="/register"
				>Register</a
			>
		</h4>
	</form>
